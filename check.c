...
void	input_tetra(int type_x[4], int type_y[4], t_tetra_list **node)
{
	...
	add_tetra_type_x(type_x[0] - x_min, type_x[1] - x_min,
	type_x[2] - x_min, type_x[3] - x_min);
	add_tetra_type_y(type_y[0] - y_min, type_y[1] - y_min,
	type_y[2] - y_min, type_y[3] - y_min);
